...
export const ComfortsRooms = () => {
  ...
  const handleBedroomsDecrement = () =>
    bedroomsDecrement(bedrooms - 1 >= 1 ? bedrooms - 1 : bedrooms);
  const handleBedsIncrement = () => bedsIncrement(beds + 1);
  const handleBedsDecrement = () =>
    bedsDecrement(beds - 1 >= 1 ? beds - 1 : beds);
  const handleBathroomsIncrement = () => bathroomsIncrement(bathrooms + 1);
  const handleBathroomsDecrement = () =>
    bathroomsDecrement(bathrooms - 1 >= 1 ? bathrooms - 1 : bathrooms);
